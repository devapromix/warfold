...
begin
  for j := 0 to Height - 1 do
    for i := 0 to Width - 1 do
      if Obj[ i, j ] <> nil then Obj[ i, j ].Free;
...
begin
  for j := 0 to Height - 1 do
    ...
    begin
      ...
      if IsWall( i, j - 1 ) = False then ssprite2d_Draw( WWhiteTex, i * 32, j * 32, 32, 32, 0, 100 );
      if IsWall( i - 1, j ) = False then ssprite2d_Draw( WWhiteTex, i * 32, j * 32, 32, 32, 270, 100 );
    end;
end;
